...
class Settings(BaseSettings):
    ...
    # Environment variables arrive as strings; constrain after normal integer
    # coercion so the CI default ``'3'`` remains valid while preserving the
    # exact three-variant contract.
